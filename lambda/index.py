...
SOURCE_BUCKET_NAME = 'client-data-backup-12345678'  
DESTINATION_BUCKET_NAME = 'pii-remediation-store'
SNS_TOPIC_ARN = 'arn:aws:sns:eu-north-1:533267059964:cloud-security-scout'
...
def move_sensitive_file(source_bucket, object_key):
    try:
        ...
        s3.head_object(Bucket=source_bucket, Key=object_key)
